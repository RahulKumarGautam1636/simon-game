...
const TakeHome = ({ modalAction, compCodeAction }) => {
  ...
  return (
    <section className="selection-page" style={{ fontSize: "0.9em" }}>
      <img id="main-logo" className="img-fluid" src="assets/img/takehome/landing_page/logo.png" alt="Footer Logo" />
      <div className="heading-sec justify-content-center justify-content-lg-around">
      ...
      <div className="content-grid d-none d-lg-flex">
        <Link to="#" className="d-non d-lg-flex card-item" onClick={() => openLogin('agro', TAKEHOME_AGRO)} style={{transform: "translateY(1.6em) scale(0.95)"}}>
          <p className="float-label">COMING SOON</p>
          <img className="img-fluid" src="assets/img/takehome/landing_page/grocery2.PNG" alt="Agro" />
          <h3>Agro & Grocery</h3>
        </Link>
        <Link to="#" className="bx-shadow-1 card-item" onClick={() => openLogin('pharma', TAKE_HOME_ID)} style={{transform: "scale(1.1)"}}>
          <img className="img-fluid" src="assets/img/takehome/landing_page/medicine2.PNG" alt="Pharmacy" />
          <h3>Medicines, Healthcare & Surgical</h3>
        </Link>
        <Link to="#" className="d-non d-lg-flex card-item" onClick={() => openLogin("gna", TAKEHOME_GARMENTS)} style={{transform: "translateY(1.6em) scale(0.95)"}}>
          <p className="float-label">COMING SOON</p>
          <img className="img-fluid" src="assets/img/takehome/landing_page/garments.jpeg" alt="Garments" />
          <h3>Garments & Fashion Accesories</h3>
        </Link>
        <Link to="#" className="d-non d-lg-flex card-item" href="#" style={{transform: "translateY(1.6em) scale(0.95)"}} onClick={() => openLogin("ea", TAKEHOME_ELECTRONICS)}>
          <p className="float-label">COMING SOON</p>
      ...
      <div className="content-grid mobile-view mt-0 pb-3 d-lg-none gap-4 p-4 mb-20">
        <Link to="#" className="card-item" onClick={() => openLogin("pharma", TAKE_HOME_ID)} style={{ padding: "1em" }}>
          <img className="img-fluid" src="assets/img/takehome/landing_page/medicine2.PNG" alt="Pharmacy" />
          <h3>Medicines &amp; Healthcare</h3>
        </Link>
        <div>
          <Link to="#" className="card-item p-4 position-relative" onClick={() => openLogin("agro", TAKEHOME_AGRO)}>
            <p className="float-label">COMING SOON</p>
            <img className="img-fluid" src="assets/img/takehome/landing_page/grocery2.PNG" alt="Agro" />
            <h3>Agro & Grocery</h3>
          </Link>
          <Link to="#" className="card-item p-4 position-relative" onClick={() => openLogin("gna", TAKEHOME_GARMENTS)}>
            <p className="float-label">COMING SOON</p>
            <img className="img-fluid" src="assets/img/takehome/landing_page/garments.jpeg" alt="Garments" />
            <h3>Garments & Fashion</h3>
          </Link>
        </div>
          <Link to="#" className="card-item p-4 position-relative" onClick={() => openLogin("ea", TAKEHOME_ELECTRONICS)}>
            <p className="float-label">COMING SOON</p>
            <img className="img-fluid" src="assets/img/takehome/landing_page/appliance.jpeg" alt="Electronics Appliances" />
            <h3>Electronic Appliances</h3>
          </Link>
          {/* <a className="card-item p-4 position-relative" href="#">
            <p className="float-label">COMING SOON</p>
            <img className="img-fluid" src="assets/img/takehome/landing_page/finance.jpeg" alt="Garments" />
            <h3>Loans & Insurance</h3>
          </a> */}
      </div>
      ...
      <div style={{ padding: "1em clamp(0.5em, 3vw, 3.6em) 0" }} className="overflow-hidden text-[0.75em]">
      ...
      <div style={{ padding: "0 clamp(0.5em, 3vw, 3.6em) 0" }} className="overflow-hidden text-[0.75em]">
        <div className="cat-slider w-100">
      ...
      {/* <div style={{ padding: "2em clamp(0.5em, 3vw, 3.6em) 0" }} className="overflow-hidden">
        <div className="cat-slider w-100">
          {renderContent(rentCategory, 'rent')}
        </div>
      </div> */}
