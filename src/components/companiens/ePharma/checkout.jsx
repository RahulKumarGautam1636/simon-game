...
//         TaxableAmount: num((i.Amount) - ((i.Amount * i.IGSTRATE) / (i.IGSTRATE + 100))),
//         CGSTRATE: i.CGSTRATE,
//         SGSTRATE: i.SGSTRATE,
//         IGSTRATE: i.IGSTRATE,
...
//                                                                     <button type='button' onClick={() => submitNote(item)} className="input-group-text" id="basic-addon2" >Add Note</button>
//                                                                 </div>
//                                                             </td>
//                                                         </tr>
//                                                     </> : ''}
...
//                                                         <div className="input-group flex-nowrap position-relative">
//                                                             <input className="form-control fw-bold" onChange={(e) => setNote(pre => ({...pre, text: e.target.value}))} value={note.text} name="Note" type="text" placeholder="Write Notes" />
//                                                             <button type='button' onClick={() => submitNote(item, 'previous order')} className="input-group-text" id="basic-addon2" >Add Note</button>
//                                                         </div>
//                                                     </td>
//                                                 </tr>: ''}
//                                             </Fragment>
